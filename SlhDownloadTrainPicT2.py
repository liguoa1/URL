...
def downloadPic2():
    cur.execute("select stdclassid from calamodel.dres_with_calss_pic where stdclassid= 1049 "
                "group by stdclassid having count(*)>1000 order by stdclassid limit 10")
...
downloadPic2()
# try:
#     _thread.start_new_thread(downloadPic2, ())
# except:
#     print
